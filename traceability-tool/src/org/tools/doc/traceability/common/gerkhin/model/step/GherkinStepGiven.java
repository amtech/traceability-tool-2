...
/**
 * Class modeling a Gherkin Given step.
 * 
 * @author Yann Leglise
 *
 */
public class GherkinStepGiven extends AbstractGherkinStep {
     ...
     */
    public GherkinStepGiven(final int pSourceFileLineNumber, final String pStepText) {
        super(GherkinConstants.GIVEN_KEYWORD, pSourceFileLineNumber, GherkinStepType.Given, pStepText);
    }
}
