...
/**
 * Class modeling a Gherkin And step.
 * 
 * @author Yann Leglise
 *
 */
public class GherkinStepAnd extends AbstractGherkinStep {
     ...
     */
    public GherkinStepAnd(final int pSourceFileLineNumber, final String pStepText) {
        super(GherkinConstants.AND_KEYWORD, pSourceFileLineNumber, GherkinStepType.And, pStepText);
    }
}
