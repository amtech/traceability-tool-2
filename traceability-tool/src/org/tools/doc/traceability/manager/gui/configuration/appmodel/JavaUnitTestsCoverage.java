...
/**
 * Coverage for java unit tests.
 * 
 * @author Yann Leglise
 *
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class JavaUnitTestsCoverage extends AbstractConfigurationModel {

    /**
     * Serial ID.
     */
    private static final long serialVersionUID = 6968653227552347716L;
